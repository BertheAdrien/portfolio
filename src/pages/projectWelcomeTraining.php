    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="doc-section" style="margin-bottom: 40px;">
                ...
                <img src="/public/assets/docs/WelcomeTrainingMCD.png" alt="MCD WelcomeTraining" class="img-responsive" style="max-width:100%; border: 1px solid #ccc; padding: 10px;">
            </div>
            ...
            <div class="doc-section" style="margin-bottom: 40px;">
                ...
                <img src="/public/assets/docs/WelcomeTrainingUseCase.png" alt="Diagramme de cas d’utilisation WelcomeTraining" class="img-responsive" style="max-width:100%; border: 1px solid #ccc; padding: 10px;">
            </div>
