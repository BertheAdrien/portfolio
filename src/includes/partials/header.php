...
<html>
	...
	<link rel="stylesheet" href="<?php echo asset('/css/supercool.css'); ?>">
	<link rel="stylesheet" href="<?php echo asset('/css/test.css'); ?>">

	<!-- Modernizr JS -->
	<script src="<?php echo asset('/js/modernizr-2.6.2.min.js'); ?>"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li <?php if ($currentPage == 'realisations') echo 'class="active"'; ?>><a href="?page=realisations">Réalisations</a>
							<li <?php if ($currentPage == 'competences') echo 'class="active"'; ?>><a href="?page=competences">Compétences</a>
